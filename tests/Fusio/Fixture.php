...
JSON;
        ...
        return [
            ...
            'fusio_action' => [
                ...
                ['name' => 'Sql-Fetch-Row', 'class' => 'Fusio\Action\SqlFetchRow', 'config' => serialize(['connection' => 1, 'sql' => 'SELECT * FROM app_news']), 'date' => '2015-02-27 19:59:15'],
            ],
            'fusio_app' => [
            ...
            'fusio_scope_routes' => [
                ...
                ['scopeId' => 4, 'routeId' => 38, 'allow' => 1, 'methods' => 'GET|POST|PUT|DELETE'],
            ],
            'fusio_user_scope' => [
                ['userId' => 2, 'scopeId' => 3],
                ['userId' => 2, 'scopeId' => 4],
