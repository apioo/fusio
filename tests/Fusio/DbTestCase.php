...
class DbTestCase extends \PHPUnit_Extensions_Database_TestCase
{
    ...
    public function getDataSet()
    {
        ...
        $dataSet = array_merge_recursive($version->getInstallInserts(), $this->getTestInserts());

        return new \PHPUnit_Extensions_Database_DataSet_ArrayDataSet($dataSet);
    }

    protected function getTestInserts()
    {
        $schemaSource = <<<'JSON'
{
    "id": "http://phpsx.org#",
...
JSON;
        ...
        return [
            ...
            'fusio_action' => [
                ['name' => 'Sql-Fetch-All', 'class' => 'Fusio\Action\SqlFetchAll', 'config' => 'a:2:{s:10:"connection";i:1;s:3:"sql";s:22:"SELECT * FROM app_news";}', 'date' => '2015-02-27 19:59:15'],
                ['name' => 'Sql-Fetch-Row', 'class' => 'Fusio\Action\SqlFetchRow', 'config' => 'a:2:{s:10:"connection";i:1;s:3:"sql";s:22:"SELECT * FROM app_news";}', 'date' => '2015-02-27 19:59:15'],
            ],
            'fusio_app' => [
                ...
                ['userId' => 2, 'status' => 2, 'name' => 'Deactivated', 'url' => 'http://google.com', 'appKey' => 'f46af464-f7eb-4d04-8661-13063a30826b', 'appSecret' => '17b882987298831a3af9c852f9cd0219d349ba61fcf3fc655ac0f07eece951f9', 'date' => '2015-02-22 22:19:07'],
            ],
            'fusio_connection' => [
                ['name' => 'DBAL', 'class' => 'Fusio\Connection\DBAL', 'config' => 'a:5:{s:4:"type";s:9:"pdo_mysql";s:4:"host";s:9:"127.0.0.1";s:8:"username";s:4:"root";s:8:"password";s:3:"foo";s:8:"database";s:3:"bar";}'],
            ],
            'fusio_routes' => [
            ...
            'fusio_scope_routes' => [
                ['scopeId' => 3, 'routeId' => 34, 'allow' => 1, 'methods' => 'GET|POST|PUT|DELETE'],
            ],
            'fusio_user_scope' => [
                ['userId' => 2, 'scopeId' => 1],
                ['userId' => 2, 'scopeId' => 2],
