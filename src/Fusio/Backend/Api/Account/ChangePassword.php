...
namespace Fusio\Backend\Api\Account;
...
class ChangePassword extends SchemaApiAbstract
{
    ...
    public function getDocumentation()
    {
        ...
        $resource->addMethod(Resource\Factory::getMethod('PUT')
            ->setRequest($this->schemaManager->getSchema('Fusio\Backend\Schema\Account\ChangePassword'))
    ...
    protected function doUpdate(RecordInterface $record, Version $version)
    {
        ...
        // change password
        $result = $this->tableManager->getTable('Fusio\Backend\Table\User')
